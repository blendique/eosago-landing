...
const advantages = [
    ...
    { id: 3, title: 'Регулярные выплаты', desc: 'Выплата агентского КВ в течении 3-х дней по запросу', icon: '💸' },
    { id: 4, title: 'Положительное решение', desc: 'Уровень одобрения сделки выше 95%', icon: '✅' },
    { id: 5, title: 'Высокое КВ', desc: 'Размер агентского КВ от 0 до 60%', icon: '📈' },
